...
module.exports = function(_, passport, User, validator){
    ...
    return {
        ...
        indexPage: function(req, res){
            ...
            return res.render('index', {title: 'Chatbox | Login', messages: errors, hasErrors: errors.length > 0});
        },
        ...
        getSignUp: function(req, res){
            const errors = req.flash('error');
            return res.render('signup', {title: 'Chatbox | SignUp', messages: errors, hasErrors: errors.length > 0});
        },
